...
public class NumberSetting<N extends Number> extends Setting<N> {
    ...
    // Constructors
    //================================================================================
    protected NumberSetting(String name, N defaultValue, Settings container) {
    ...
    // Impl
    //================================================================================
    public static NumberSetting<Double> forDouble(String name, double defaultVal, Settings container) {
        NumberSetting<Double> setting = new NumberSetting<>(name, defaultVal, container);
